...
const Editor = () => {
    ...
    useEffect(() => {
        ...
        fabricCanvas.on('selection:cleared', () => {
            ...
            console.log("Cleared: ", activeObject);
        ...
        fabricCanvas.on('mouse:dblclick', (e) => {
            ...
            if (target && target.type === 'image') {
                ...
                //     scaleX,
                //     scaleY
                // } = target.originalTextData;

                // alert(dynamicFontSize)
        ...
        fabricCanvas.on('object:moving', () => {
            ...
            // if (activeObject && activeObject.type === 'i-text') {
            //     console.log(activeObject.left, activeObject.top, activeObject.width);
            // }
        })
            ...
            reader.onload = (e) => {
                ...
                fabric.loadSVGFromString(svgContent, (objects, options) => {
                    ...
                    newObjects.forEach((obj, key) => {
                        if (obj.text) {
                            // uploadedITexts.push({ id: key, iTextId: obj.id, obj: obj, texture: "" });
                            uploadedITextsRef.current.push({ id: key, iTextId: obj.id, obj: obj, texture: "" });
                        }
                        canvas.add(obj);
                    });
                    console.log(uploadedITextsRef.current);
                    canvas.renderAll();
                });
            };
    ...
    const applyBridgeEffect = (bridgeObject) => {
        ...
        fabric.Image.fromURL(dataURL, (img) => {
            ...
            img.set({
                ...
                originY: 'top',
                selectable: true,
                scaleX: Math.min(1.5, canvasWidth / measuredWidth)
            });
